...
class CombinerChain(initialText: String, combiningSpec: String) {
    ...
    init {
        ...
        if (combiningSpec == "hangul")
            ...
            mCombiners.add(VietnameseTelexCombiner(::configuredVietnameseTonePlacement))
        else if (combiningSpec == "vi_vni")
            mCombiners.add(VietnameseVniCombiner(::configuredVietnameseTonePlacement))
    }
