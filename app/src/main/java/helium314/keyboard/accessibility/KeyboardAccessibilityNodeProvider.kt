...
class KeyboardAccessibilityNodeProvider<KV : KeyboardView>(
    ...
    override fun createAccessibilityNodeInfo(virtualViewId: Int): AccessibilityNodeInfoCompat? {
        ...
        if (virtualViewId == View.NO_ID) {
            ...
            // AndroidX deprecated the compatibility dispatcher. On our Android 12+ floor the
            // platform callback provides the same delegate-aware initialization path.
            mKeyboardView.onInitializeAccessibilityNodeInfo(rootInfo.unwrap())
