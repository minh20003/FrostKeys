...
open class SettingsActivity : ComponentActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        crashReportFiles.value = if (BuildConfig.DEBUG) {
            findCrashReports()
        } else {
            // Remove reports written by an older/debug build rather than offering to export text
            // that may contain an editor payload or credential-related stack trace.
            deleteCrashReports()
            emptyList()
        }
        ...
        cv.setContent {
            Theme {
                Surface {
                    ...
                    val crashFilePicker = if (BuildConfig.DEBUG) filePicker { saveCrashReports(it) } else null
                    ...
                    if (spellchecker)
                        ...
                        if (!showWelcomeWizard) {
                            if (BuildConfig.DEBUG && crashReports.isNotEmpty()) {
                                ConfirmationDialog(
                                    cancelButtonText = stringResource(R.string.crash_reports_action_ignore),
                                    ...
                                    confirmButtonText = stringResource(R.string.crash_reports_action_get),
                                    onConfirmed = {
                                    ...
                                    content = { Text(stringResource(R.string.crash_reports_found)) },
                                )
                            } else {
                                             ...
                                             Column(
                                                 ...
                                                 horizontalAlignment = Alignment.CenterHorizontally
                                                  ...
                                                  Image(
                                                      ...
                                                      contentDescription = stringResource(R.string.telegram_logo_content_description),
                                                      modifier = Modifier
                                                          .size(96.dp)
                                                          .padding(bottom = 16.dp)
                                                  )
                                                 Text(
                                                     text = stringResource(R.string.telegram_popup_title),
                                                 ...
                                                 Text(
                                                     text = stringResource(R.string.telegram_popup_message),
                                                 ...
                                                 Row(
                                                     ...
                                                     OutlinedButton(
                                                         ...
                                                         Text(
                                                             text = stringResource(R.string.telegram_maybe_later),
                                                     ...
                                                     Button(
                                                         ...
                                                         Text(
                                                             text = stringResource(R.string.telegram_join_now),
                                                             fontWeight = FontWeight.Bold
                                                         )
                                                     }
                                                 }
    ...
    private fun deleteCrashReports() {
        findCrashReports().forEach(File::delete)
    }
