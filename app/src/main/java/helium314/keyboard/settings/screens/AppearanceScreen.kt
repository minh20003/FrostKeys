...
fun AppearanceScreen(
    ...
    val dayNightMode = prefs.getBoolean(Settings.PREF_THEME_DAY_NIGHT, Defaults.PREF_THEME_DAY_NIGHT)
...
fun createAppearanceSettings(context: Context) = listOf(
    Setting(context, Settings.PREF_THEME_STYLE, R.string.theme_style) { setting ->
        ...
        val descriptions = mapOf(
            KeyboardTheme.STYLE_DEFAULT to R.string.theme_style_default_description,
            KeyboardTheme.STYLE_MATERIAL to R.string.theme_style_material_description,
            KeyboardTheme.STYLE_HOLO to R.string.theme_style_holo_description,
            KeyboardTheme.STYLE_ROUNDED to R.string.theme_style_rounded_description,
            KeyboardTheme.STYLE_CIRCLE to R.string.theme_style_circle_description,
        )
        ListPreference(
            setting = setting,
            items = items,
            default = Defaults.PREF_THEME_STYLE,
            itemDescriptions = { descriptions[it]?.let(ctx::getString) }
        ) {
