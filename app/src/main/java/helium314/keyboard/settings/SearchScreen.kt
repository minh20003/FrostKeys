            ...
            Scaffold(
                ...
                topBar = {
                    val topBarHazeStyle = remember(topBarBg) {
                        HazeStyle(blurRadius = 16.dp, tint = HazeTint(topBarBg.copy(alpha = 0.3f)))
                    }
                    AnimatedVisibility(
                                        ...
                                        IconButton(
                                            ...
                                            Box(
                                                ...
                                                Icon(
                                                    ...
                                                    contentDescription = stringResource(R.string.settings_navigation_back),
...
fun StaticSearchField(
    ...
    TextField(
        ...
        leadingIcon = {
            Icon(
                painter = painterResource(R.drawable.sym_keyboard_search_lxx),
