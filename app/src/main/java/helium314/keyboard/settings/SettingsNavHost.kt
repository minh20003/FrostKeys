...
import helium314.keyboard.settings.screens.AppLanguageScreen
    ...
    NavHost(
        ...
        composable(SettingsDestination.Settings) {
            MainSettingsScreen(
                ...
                onClickAppLanguage = { navController.navigate(SettingsDestination.AppLanguage) },
...
/*      will be added as part of passive data gathering
        ...
        composable(SettingsDestination.AppLanguage) {
            AppLanguageScreen(onClickBack = ::goBack)
        }
