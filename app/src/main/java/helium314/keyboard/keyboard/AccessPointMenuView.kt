...
class AccessPointMenuView @JvmOverloads constructor(
            ...
            try {
                ...
                if (colors.themeStyle == helium314.keyboard.keyboard.KeyboardTheme.STYLE_ROUNDED || colors.themeStyle == helium314.keyboard.keyboard.KeyboardTheme.STYLE_CIRCLE) {
                    ...
                    context.withStyledAttributes(
                        ...
                        iconView.background = colors.selectAndColorDrawable(this, ColorType.KEY_BACKGROUND)
                    }
                }
                ...
                try {
                    ...
                    Log.e("AccessPointMenuView", "Failed to load drawable for ${key.name}", e)
                }
                if (drawable == null) {
                ...
                Log.e("AccessPointMenuView", "Resource not found for tile ${key.name}", e)
            }
    ...
    private fun saveToolbarKeyOrder(grid: GridLayout) {
        ...
        prefs.edit {
            putString(Settings.PREF_TOOLBAR_KEYS, newEntries.joinToString(Constants.Separators.ENTRY))
        }
