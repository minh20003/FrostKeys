...
public class SettingsValues {
    ...
    public SettingsValues(final Context context, final SharedPreferences prefs, final Resources res,
        ...
        // VNI uses number keys as composition modifiers, so its subtype always exposes the
        // number row. Other layouts keep the user's global preference.
        final boolean isVietnameseVni = selectedSubtype.getExtraValue().contains("CombiningRules=vi_vni");
        mShowsNumberRow = isVietnameseVni || prefs.getBoolean(Settings.PREF_SHOW_NUMBER_ROW, Defaults.PREF_SHOW_NUMBER_ROW);
