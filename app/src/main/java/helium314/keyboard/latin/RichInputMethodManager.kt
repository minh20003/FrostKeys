...
class RichInputMethodManager private constructor() {
    // This object is process-global. Retain data/services, not an IME or Activity Context.
    ...
    fun onSubtypeChanged(newSubtype: InputMethodSubtype) {
        SubtypeSettings.setSelectedSubtype(prefs, newSubtype)
    ...
    fun refreshSubtypeCaches() {
        ...
        currentRichInputMethodSubtype = RichInputMethodSubtype.get(SubtypeSettings.getSelectedSubtype(prefs))
        scope.launch { updateShortcutIme() }
    }
