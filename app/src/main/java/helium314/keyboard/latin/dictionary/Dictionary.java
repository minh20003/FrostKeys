...
public abstract class Dictionary {
    ...
    // A sealed, offline next-word seed model. It is intentionally distinct from hardcoded UI
    // suggestions and from user history so diagnostics/privacy code can identify its provenance.
    public static final String TYPE_VIETNAMESE_PHRASE_MODEL = "vietnamese_phrase_model";
    public static final PhonyDictionary DICTIONARY_VIETNAMESE_PHRASE_MODEL =
            new PhonyDictionary(TYPE_VIETNAMESE_PHRASE_MODEL);
