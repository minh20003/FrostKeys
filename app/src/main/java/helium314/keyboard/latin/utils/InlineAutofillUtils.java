...
public class InlineAutofillUtils {
    ...
    public static InlineSuggestionsRequest createInlineSuggestionRequest(final Context context) {
        ...
        // Keep the inline surface self-contained: the AndroidX drawable is private and may
        // disappear without a compatibility guarantee.
        final int chipBgDrawableId = R.drawable.inline_autofill_chip_background;
