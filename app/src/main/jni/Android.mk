...
# Android 15 devices may use 16 KiB pages. Keep PT_LOAD alignment compatible for the
# arm64 personal build; this must be applied to every native engine bundled later as well.
